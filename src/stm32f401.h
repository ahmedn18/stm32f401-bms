...
#define RCC_PLLCFGR *((volatile unsigned int*)(RCC_PLLCFG_baseAddress +RCC_PLLCFG_offset))
#define RCC_CFGR *((volatile unsigned int*)(RCC_CFGR_baseAddress +RCC_CFGR_offset))
